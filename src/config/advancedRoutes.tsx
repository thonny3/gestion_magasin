...
export const advancedRouteConfig: RouteObject[] = [
  ...
  },
  {
    ...
    meta: {
      title: 'Distributions',
      description: 'Gérer les distributions de stock',
      icon: 'Users',
      breadcrumb: ['Tableau de Bord', 'Distributions'],
      tabs: [
        { id: 'liste', label: 'Liste des Distributions', path: '/distribution' },
        { id: 'planification', label: 'Planification', path: '/distribution/planification' },
        { id: 'rapports', label: 'Rapports', path: '/distribution/rapports' }
      ]
    }
  },
  {
  ...
  },
  {
    ...
    meta: {
      ...
      description: 'Suivre les paiements et facturations',
      icon: 'DollarSign',
      breadcrumb: ['Tableau de Bord', 'États de Paiement'],
      tabs: [
        { id: 'paiements', label: 'Paiements', path: '/paiement' },
        { id: 'factures', label: 'Factures', path: '/paiement/factures' },
        { id: 'impayes', label: 'Impayés', path: '/paiement/impayes' }
      ]
    }
  },
  {
    ...
    meta: {
      ...
      description: 'Gérer les missions et déplacements',
      icon: 'MapPin',
      breadcrumb: ['Tableau de Bord', 'Ordres de Mission'],
      tabs: [
        { id: 'missions', label: 'Missions', path: '/mission' },
        { id: 'planification', label: 'Planification', path: '/mission/planification' },
        { id: 'suivi', label: 'Suivi en Temps Réel', path: '/mission/suivi' }
      ]
    }
  },
  {
