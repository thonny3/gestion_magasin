        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white p-12">
          <div className="text-center max-w-md animate-fade-in-left">
            <div className="flex justify-center mb-8">
              <div className="w-20 h-20 glass rounded-full flex items-center justify-center animate-float">
      ...
      <div className="flex-1 flex items-center justify-center p-8 gradient-secondary">
        <div className="w-full max-w-md animate-fade-in-up">
          ...
          <div className="lg:hidden text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-600 rounded-full mb-4 animate-float">
